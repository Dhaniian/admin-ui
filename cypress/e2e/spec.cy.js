describe("User login", () => {
  it("should successfully login with valid student credentials", () => {
    ...
    cy.get("input#email")
      ...
      .type("111202214153@mhs.dinus.ac.id")
      .should("have.value", "111202214153@mhs.dinus.ac.id");
  ...
  it("should display error for email without @ character", () => {
    cy.visit("http://localhost:5173/");
    cy.url().should("include", "/login");
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214153mhs.dinus.ac.id")
      .should("have.value", "111202214153mhs.dinus.ac.id");
  ...
  it("should display error for incomplete email address", () => {
    cy.visit("http://localhost:5173/");
    cy.url().should("include", "/login");
    ...
    cy.get("input#email")
      ...
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214153@")
      .should("have.value", "111202214153@");
  ...
  it("should display error for email missing domain separator", () => {
    cy.visit("http://localhost:5173/");
    cy.url().should("include", "/login");
    ...
    cy.get("input#email")
      .should("be.visible")
      .should("have.attr", "placeholder", "hello@example.com")
      .type("111202214153@mhsdinusacid")
      .should("have.value", "111202214153@mhsdinusacid");
...
describe("Dashboard Overview", () => {
  ...
  it("should verify presence of essential dashboard components", () => {
  ...
  it("should verify balance information display", () => {
  ...
  it("should confirm goals data presentation", () => {
    cy.wait('@getGoals');
  ...
  it("should verify bills section content", () => {
    cy.wait('@getBills');
  ...
  it("should test transaction filter functionality", () => {
  ...
  it("should verify statistics chart display", () => {
  ...
  it("should confirm expenses breakdown visibility", () => {
